...
public class TopLogger {
	...
	public static void logErrorScene(Map<String, Object> rt, BaseResponse tRsp, String appSecret) {
		...
		appendLog((PureStringHashMap)rt.get("protocalMustParams"), sb);
		sb.append("^_^");
		sb.append("ProtocalOptParams:");
		appendLog((PureStringHashMap)rt.get("protocalOptParams"), sb);
		sb.append("^_^");
		sb.append("ApplicationParams:");
		appendLog((PureStringHashMap)rt.get("textParams"), sb);
		sb.append("^_^");
		sb.append("Body:");
	...
	private static void appendLog(PureStringHashMap map, StringBuilder sb) {
		boolean first = true;
