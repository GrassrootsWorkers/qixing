package com.dream.qixing.constants;
...
public class Global {
	...
	public static final String LOING_COOKIE_NAME = "user.btoc.111.com.cn";

	public static final String ADMIN_COOKIE_NAME = "admin.btoc.111.com.cn";
